...
if (onnxruntime_USE_TIDL)
  ...
  target_include_directories(onnxruntime_providers_tidl PRIVATE ${CMAKE_CURRENT_BINARY_DIR} "${CMAKE_CURRENT_BINARY_DIR}/_deps/google_nsync-src/public/" "${CMAKE_CURRENT_BINARY_DIR}/_deps/mp11-src/include/" "${CMAKE_CURRENT_BINARY_DIR}/_deps/google_nsync-src/public/" "${CMAKE_CURRENT_BINARY_DIR}/_deps/mp11-src/include/" "${CMAKE_CURRENT_BINARY_DIR}/_deps/flatbuffers-src/include" ${ONNXRUNTIME_ROOT}  ${eigen_INCLUDE_DIRS} ${TIDL_RT_INCLUDE_DIR} ${TIDL_IT_INCLUDE_DIR} ${TIDL_INCLUDE_DIR} ${TIDL_IVISION_INCLUDE_DIR} ${TIDL_ONNX_INFER_INCLUDE_DIR} ${TIDL_COMMON_DIR})
