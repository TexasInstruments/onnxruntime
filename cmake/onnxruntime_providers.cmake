...
if (onnxruntime_USE_TIDL)
  ...
  target_include_directories(onnxruntime_providers_tidl PRIVATE ${ONNXRUNTIME_ROOT} ${eigen_INCLUDE_DIRS} ${TIDL_RT_INCLUDE_DIR} ${TIDL_IT_INCLUDE_DIR} ${TIDL_EP_INCLUDE_DIR} ${TIDL_COMMON_INCLUDE_DIR} ${TIDL_INCLUDE_DIR} ${TIDL_IVISION_INCLUDE_DIR} ${TIDL_ONNX_INFER_INCLUDE_DIR} ${TIDL_COMMON_DIR})
