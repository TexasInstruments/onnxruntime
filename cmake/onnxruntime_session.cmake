...
target_include_directories(onnxruntime_session PRIVATE ${ONNXRUNTIME_ROOT} ${PROJECT_SOURCE_DIR}/external/json ${eigen_INCLUDE_DIRS} ${TIDL_RT_INCLUDE_DIR} ${TIDL_IT_INCLUDE_DIR} ${TIDL_INCLUDE_DIR} ${TIDL_IVISION_INCLUDE_DIR})
